...
// Message Constant
define('PRECONDITION_FAILED','Precondition Failed');
define('BAD_REQUEST','Bad Request');
define('SUCCESSFUL','Successful');
define('FAILED','Failed');
define('UPDATE_SUCCESSFUL','Updated Successfully');
define('UPDATE_FAILED','Failed to Update');
define('ALREADY_EXISTS','Already Exists');
define('USER_CREATE_SUCCESSFUL','User Created Successfully');
define('USER_CREATE_FAIL','User Can Not be Created');
define('LOGIN_SUCCESSFUL','Logged In Successfully');
define('LOGIN_FAIL','Log In Failed');
define('SOMETHING_WENT_WRONG','Something Went Wrong');
define('CREATE_SUCCESSFUL','Created Successfully');
